...
class SBusClientMessages:
    ...
    def SBRequest(self, msgsequence, stnaddr, cmdcode, datacount, dataaddr, msgdata=None):
        ...
        if (cmdcode in (2, 3, 5, 11, 13) and (datacount > 128)):
        ...
        # Write flags, outputs.
            ...
            # seems buggy here (FHE)
            msg = struct.pack('>LBBHB BBBHB %ds' % len(msgdata), msglength, 0, msgsequence,
                0, stnaddr, cmdcode, bytecount, dataaddr, fiocount, msgdata)
        ...
        # Read Station Number
            ...
            # todo: pack
            msglength = 13
            msg = struct.pack('>LBBHB BB', msglength, 0, 0, msgsequence, 0,
                stnaddr, cmdcode)
