...
class HMIConfig:
	...
	def _CheckConfig(self):
		...
		standardsections = ('clientversion', 'serverid', '&events', '&alarms')
		sectionlist = [x for x in allsectionlist if not x in standardsections]
	...
	def _FormatToFile(self, config):
		...
		# Memory address many have to be unpacked from a tuple if the datatype is string.
		try:
